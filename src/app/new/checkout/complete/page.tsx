    ...
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6">
      <div className="bg-white rounded-2xl border border-gray-200 p-10 max-w-md w-full text-center">
        ...
        <div className="flex flex-col gap-2">
          <Link href="/my-orders" className="w-full bg-gray-900 text-white text-sm font-semibold py-3 rounded-xl hover:bg-gray-700 transition-colors">
            내 주문 목록 보기
          </Link>
          <Link href="/new" className="w-full border border-gray-200 text-gray-600 text-sm py-3 rounded-xl hover:bg-gray-50 transition-colors">
            계속 쇼핑하기
          </Link>
        </div>
      </div>
